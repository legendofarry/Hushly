...
import { AgeGate } from "@/components/vibe/age-gate";
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="vibe-gradient inline-flex items-center justify-center rounded-2xl px-5 py-2.5 text-sm font-semibold text-primary-foreground"
          >
            Go home
          </Link>
        </div>
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-2xl border border-border bg-surface px-5 py-2.5 text-sm font-medium text-foreground"
          >
            Go home
          </a>
        </div>
